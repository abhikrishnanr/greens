...
// Removed Header import as it's now integrated into the hero section
...
const HERO_CATEGORIES = [
  {
    ...
    description: "For Trendsetting Homes. Curated finds, just a tap away.",
    buttonLink: "#services",
    headerBgColor: "#4A238A", // Deep purple for header
    tabBgColor: "#FF8C00", // Orange for active tab
    contentBgColor: "#FF8C00", // Orange for content
    contentTextColor: "text-white",
    buttonBgColor: "bg-white",
    buttonTextColor: "text-[#522B8C]",
    poweredByImage: "/powered-by-nestasia.png",
  },
  {
    id: "maxxsaver",
    name: "Maxxsaver",
    icon: <Sparkles fill="currentColor" className="w-6 h-6" />, // Using Sparkles for Maxxsaver
    backgroundImage: "/maxsaver-bg.png",
    description: "Shop for ₹799 & unlock lowest prices!",
    buttonLink: "#services",
    headerBgColor: "#4A238A",
    tabBgColor: "#FF8C00",
    contentBgColor: "#FF8C00",
    contentTextColor: "text-white",
    buttonBgColor: "bg-white",
    buttonTextColor: "text-[#522B8C]",
    poweredByImage: "/powered-by-britannia.png",
  },
  {
    id: "rakhi",
    name: "Rakhi",
    icon: <Heart fill="currentColor" className="w-6 h-6" />, // Using Heart for Rakhi
    backgroundImage: "/rakhi-bg.png",
    description: "Get Ready For Raksha Bandhan",
    buttonLink: "#services",
    headerBgColor: "#4A238A",
    tabBgColor: "#FF4500", // Red-orange for Rakhi
    contentBgColor: "#FF4500",
    contentTextColor: "text-white",
    buttonBgColor: "bg-white",
    buttonTextColor: "text-[#522B8C]",
    poweredByImage: "/powered-by-kalyan.png",
  },
  {
    id: "fresh",
    name: "Fresh",
    icon: <Leaf fill="currentColor" className="w-6 h-6" />, // Using Leaf for Fresh
    backgroundImage: "/fresh-bg.png",
    description: "Fresh, Tasty & Healthy",
    buttonLink: "#services",
    headerBgColor: "#4A238A",
    tabBgColor: "#FF8C00",
    contentBgColor: "#FF8C00",
    ...
    buttonBgColor: "bg-white",
    buttonTextColor: "text-[#522B8C]",
    poweredByImage: "/powered-by-milkymist.png",
  },
  {
    id: "beauty",
    name: "Beauty",
    icon: <Sparkles fill="currentColor" className="w-6 h-6" />,
    backgroundImage: "/beauty-bg.png",
    description: "Your daily dose of glow and self-care.",
    buttonLink: "#services",
    headerBgColor: "#4A238A",
    tabBgColor: "#FF8C00",
    contentBgColor: "#FF8C00",
    ...
    buttonBgColor: "bg-white",
    buttonTextColor: "text-[#522B8C]",
    poweredByImage: "/powered-by-nestasia.png", // Dummy
  },
  {
    id: "gadgets",
    name: "Gadgets",
    icon: <Crown fill="currentColor" className="w-6 h-6" />,
    backgroundImage: "/gadgets-bg.png",
    description: "Latest tech and smart devices for a connected life.",
    buttonLink: "#services",
    headerBgColor: "#4A238A",
    tabBgColor: "#FF8C00",
    contentBgColor: "#FF8C00",
  ...
  },
  {
    ...
    backgroundImage: "/fashion-bg.png",
    description: "Stay trendy with our curated collection of apparel and accessories.",
    buttonLink: "#services",
    headerBgColor: "#4A238A",
    tabBgColor: "#FF8C00",
    contentBgColor: "#FF8C00",
  ...
  },
  {
    ...
    backgroundImage: "/monsoon-bg.png",
    description: "Essentials to make your monsoon comfortable and stylish.",
    buttonLink: "#services",
    headerBgColor: "#4A238A",
    tabBgColor: "#FF8C00",
    contentBgColor: "#FF8C00",
...
export default function HomePage() {
  ...
  const [selectedHeroCategory, setSelectedHeroCategory] = useState<string | null>(null) // null means default "Home" tab
  ...
  const currentHeroContent = useMemo(() => {
    return HERO_CATEGORIES.find((cat) => cat.id === (selectedHeroCategory || "home"))
  }, [selectedHeroCategory])

  // Fallback for currentHeroContent if it's undefined (shouldn't happen with "home" default)
  if (!currentHeroContent) return null
  ...
  return (
    <main className="bg-gray-900 min-h-screen font-sans text-gray-100">
      ...
      <section
        ...
        style={{ backgroundColor: currentHeroContent.headerBgColor }}
      >
        {/* Top Bar */}
        <div className="w-full bg-[#007BFF] text-white py-3 px-4 flex items-center justify-between text-sm">
          <div className="flex items-center gap-2">
            <Clock className="w-4 h-4" />
            <span>7 MINS</span>
          </div>
          <div className="flex items-center gap-2">
            <span>Delivery to PJ10300</span>
        ...
        <div className="w-full px-4 py-3 bg-transparent">
          <div className="w-full bg-white rounded-full p-3 flex items-center gap-3 shadow-md">
            <FiSearch className="text-gray-500 text-xl" />
            <input
              type="text"
              placeholder="Search for 'Paneer'" // Example placeholder from screenshot
        ...
        {/* Categories Section */}
        <div
          className="w-full overflow-x-auto py-2 scrollbar-hide shadow-lg"
          style={{ backgroundColor: currentHeroContent.headerBgColor }}
        >
        ...
        <AnimatePresence mode="wait">
          <motion.div
            ...
            style={{ backgroundColor: currentHeroContent.contentBgColor }}
          ...
          >
            ...
            <div className="relative z-30 text-white max-w-3xl space-y-6">
              {currentHeroContent.poweredByImage && (
                <Image
                  src={currentHeroContent.poweredByImage || "/placeholder.svg"}
                  alt="Powered By"
                  width={120}
                  height={30}
              ...
              <h1
                className={`text-5xl md:text-7xl font-bold tracking-wide font-[Pacifico] ${currentHeroContent.contentTextColor}`}
              >
                {currentHeroContent.name === "Home" ? "Greens Beauty Salon" : currentHeroContent.name}
              </h1>
              <p className={`text-xl md:text-2xl leading-relaxed ${currentHeroContent.contentTextColor}`}>
